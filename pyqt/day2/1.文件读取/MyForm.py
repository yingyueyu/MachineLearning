...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chooseImgBtn.setText(_translate("MainWindow", "选择图片"))
        self.resLab.setText(_translate("MainWindow", "AI识别的结果为："))
