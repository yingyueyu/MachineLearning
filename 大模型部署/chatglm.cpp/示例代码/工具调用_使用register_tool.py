...
sys_msg = f'Answer the following questions as best as you can. You have access to the following tools:\n{tool_meta_datas}'
print(sys_msg)

messages = [
    ChatMessage(role=ChatMessage.ROLE_SYSTEM, content=sys_msg),
