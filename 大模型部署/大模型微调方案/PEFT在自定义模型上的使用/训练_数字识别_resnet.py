...
def save(_model, _best_loss):
    ...
    torch.save(state_dict, 'weights/model_resnet.pt')
    with open('weights/train_meta_resnet.json', 'w') as file:
...
def load():
    ...
    try:
        state_dict = torch.load('weights/model_resnet.pt')
        _model.load_state_dict(state_dict)
        with open('weights/train_meta_resnet.json', 'r') as file:
