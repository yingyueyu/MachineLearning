...
def iou_boxes(box1, box2):
    ...
    #
    precious = inner_area / box1_area[:, None]
    print(torch.mean(precious))
    recall = inner_area / box2_area
    print(torch.mean(recall))

    mAP = (precious + recall + inner_area / union) / 3
